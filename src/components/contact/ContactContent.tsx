...
export default function ContactContent() {
  return (
    <section className="py-20 bg-white font-primary">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-block mt-2 text-primary text-sm font-bold hover:underline"
                    >
                      View on Google Maps →
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">Office & Studio Hours</h3>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-11 h-11 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 hover:bg-primary hover:text-white transition-all shadow-xs"
          ...
          {/* Contact Form */}
          <div className="lg:w-2/3 bg-gray-50 rounded-3xl p-8 md:p-12 border border-gray-200/80 shadow-md">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-hidden focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all bg-white"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-hidden focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all bg-white resize-none"
                  placeholder="How can we help you?"
                  required
                />
              </div>

              <Button size="lg" className="w-full bg-primary hover:bg-red-700 text-white font-bold py-3.5 rounded-xl shadow-md transition-all">
                Send Message
              </Button>
            </form>
          </div>
